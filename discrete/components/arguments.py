...
def get_common_args():
    ...
    parser.add_argument("--env_id", default='Predator_prey_4v4', type=str,
    ...
    parser.add_argument('--display', type=bool, default=True, help='whether to render while training or evaluating')
